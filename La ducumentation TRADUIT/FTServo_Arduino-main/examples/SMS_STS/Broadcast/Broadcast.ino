...
void loop()
{
  //Le servomoteur (diffusion) se déplace à la position P1=4095 avec une vitesse max V=60*0.732=43.92rpm et une accélération A=50*8.7deg/s^2
  sms_sts.WritePosEx(0xfe, 4095, 60, 50);
  delay((4095-0)*1000/(60*50) + (60*50)*10/(50) + 50);//[(P1-P0)/(V*50)]*1000+[(V*50)/(A*100)]*1000 + 50(erreur)

  //Le servomoteur (diffusion) se déplace à la position P0=0 avec une vitesse max V=60*0.732=43.92rpm et une accélération A=50*8.7deg/s^2
